...
[^trl-electro]: Three technologies at three readiness levels share one row.
    ...
    on synthetic solutions and nothing else, and no separation factor for any pair
    — so 2-3, on the same basis as the MOF entry below.
