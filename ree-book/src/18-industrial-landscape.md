...
Who actually separates rare earths, where, and at what scale. This chapter is
the shortest in the book and the most perishable — the projects listed here are
under construction or in commissioning, and the numbers will move.

The structural fact behind all of it is concentration: roughly 90% of global
separation capacity is in one country ([](#why-rare-earths-are-hard-to-separate)).
Every project below is, in one way or another, a response to that.

## Rare Element Resources Demonstration Plant
