...
This review covers the fundamental chemistry and engineering of liquid-liquid solvent extraction for rare-earth element (REE) separations. We examine the complete process flow: starting materials preparation, aqueous phase composition and pH control, organic phase selection (specifically why kerosene), the pH swing mechanism that drives phase transfer, extractant behavior during cycling, and liquid-liquid contactor design for industrial-scale operations.

Key points:

- REEs start as mineral concentrates (bastnasite, monazite) and are dissolved in acid to produce chloride or nitrate solutions
- Aqueous phase contains controlled concentrations of acid, salting-out agents (NaCl, Ca(NO₃)₂), and buffering agents
- Kerosene is preferred as diluent due to low cost, low water solubility, appropriate polarity, and favorable environmental profile
- pH swing mechanism exploits acid-base chemistry: extractants are weak acids that release H⁺ when coordinating REE³⁺ ions
- Liquid-liquid contactors use mixer-settlers, pulsed columns, or centrifugal contactors depending on throughput and separation requirements

# 1. Starting Materials: From Ore to Aqueous Feed Solution
## 1.1 Primary REE Minerals
...
## 1.2 Dissolution and Feed Solution Preparation
### 1.2.1 Chloride Solutions
...
### 1.2.3 Sulfate Solutions (Ion-Adsorption Ores)
...
## 1.3 Feed Solution Purification
...
# 2. Aqueous Phase Composition and Additives
## 2.1 Role of pH Control
...
## 2.2 Aqueous Phase Additives and Their Functions
### 2.2.1 Salting-Out Agents
...
### 2.2.2 Buffers and pH Control Agents
...
# 3. Organic Phase: Why Kerosene?
## 3.1 Diluent Requirements for REE Extraction
...
# 4. pH Swing Mechanism for Phase Transfer
## 4.1 Extraction Step: Aqueous → Organic
...
## 4.2 pH Dependence (The \"pH Swing\")
...
## 4.3 Extraction Cycle
### 4.3.1 Extraction Stage (Forward Transfer)
...
### 4.3.2 Scrubbing Stage (Optional)
...
### 4.3.3 Stripping Stage (Reverse Transfer)
...
# 5. Liquid-Liquid Contactor Design
## 5.1 Types of Contactors
### 5.1.1 Mixer-Settler
...
### 5.2.2 Typical Cascade Configuration
**Extraction section**:
...
## 5.3 Phase Ratio and Material Balance
...
### 5.4.2 Interfacial Area and Mass Transfer
**Mass transfer rate**:
...
### 5.4.3 Entrainment and Coalescence
...
## 5.5 Process Control and Automation
...
# 6. Industrial Example: Complete Process Flow
## 6.1 Typical REE Separation Plant (Simplified)
...
## 6.2 Material and Energy Balance (Approximate)
...
# 7. Recent Advances and High-Throughput Integration
## 7.1 High-Throughput Screening Platforms
cite:augustine2024advancing demonstrated automated platform at LANL:

- Robotic liquid handling for solvent extraction
- Automated pH adjustment
- ICP-AES characterization (200 measurements/day)
- 74% reduction in experimental effort via Bayesian optimization

## 7.2 Integration with Machine Learning
cite:liu2022advancing:

- Deep neural networks predict log D with R² = 0.85
- Database of 1202 experimental values
- Molecular descriptors and fingerprints as features
- 4 novel ligands validated experimentally

cite:gupta2025toward:

- Equivariant neural networks (Allegro) for binding energies
- 5356 REE-ligand complexes dataset
- MAE = 6.1 kcal/mol for direct energy prediction
- Bypasses DFT for rapid screening

## 7.3 Automated Process Control
...
## 8.1 Critical Parameters Summary
...
2.  Use appropriate salting agents for your acid medium
...
cite:xie2014critical cite:jha2016review cite:zhang2016rare cite:rydberg2004solvent cite:tanaka2021revaluating cite:li2020hydration cite:iloeje2019gibbs cite:khoshoei2025crown cite:matveev2018solvent cite:agarwal2020comparative cite:han2024efficient cite:sun2018nature cite:dewulf2022effect cite:thiele2020tuning cite:augustine2024advancing cite:liu2022advancing cite:gupta2025toward cite:pramanik2024emerging
