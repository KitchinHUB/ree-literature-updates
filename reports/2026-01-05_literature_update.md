...
### 1. Optimization and scale-up of a microscale ion exchange separation for an adjacent lanthanide pair

**Authors:** Susanna B. Angermeier, Ashleigh Kimberlin, Miguel Toro Gonzalez, Kevin Gaddis, Sandra Davern, et al.

**Published:** 2026-01-02 | **Journal:** Separation Science and Technology | **Citations:** 0 | **Access:** 🔒

**DOI:** [https://doi.org/10.1080/01496395.2025.2607657](https://doi.org/10.1080/01496395.2025.2607657)

**Topics:** Chemistry, Lanthanide, Microscale chemistry, Ion exchange, Ion

---

### 2. Optimization and scale-up of a microscale ion exchange separation for an adjacent lanthanide pair

**Authors:** Susanna B. Angermeier, Ashleigh Kimberlin, Miguel Toro Gonzalez, Kevin Gaddis, Sandra Davern, et al.

**Published:** 2026-01-01 | **Journal:** Unknown Source | **Citations:** 0 | **Access:** 🔓

**DOI:** [https://doi.org/10.6084/m9.figshare.30988359](https://doi.org/10.6084/m9.figshare.30988359)

**Abstract:** Radiolanthanides are important for cancer therapy and diagnostics but are challenging to chemically purify post production because of charge and ionic radii similarities. Conventional-scale ion exchange chromatography is commonly used, often requiring large volumes of costly resins, creating significant radioactive waste, and can be time-consuming. Microfluidic ion exchange separations can advance research and development using minimal resources to inform conventional column chromatography scale...

**Topics:** Microscale chemistry, Lanthanide, Elution, Ion exchange, Ion chromatography

---

### 3. Optimization and scale-up of a microscale ion exchange separation for an adjacent lanthanide pair

**Authors:** Susanna B. Angermeier, Ashleigh Kimberlin, Miguel Toro Gonzalez, Kevin Gaddis, Sandra Davern, et al.

**Published:** 2026-01-01 | **Journal:** Unknown Source | **Citations:** 0 | **Access:** 🔓

**DOI:** [https://doi.org/10.6084/m9.figshare.30988359.v1](https://doi.org/10.6084/m9.figshare.30988359.v1)
...
### 4. Solvent extraction of rare earth elements and α-alumina production from pregnant leaching solution obtained from Turkish bauxite-related ore

**Authors:** Ceren Erust, Turan Uysal

**Published:** 2025-12-30 | **Journal:** Separation Science and Technology | **Citations:** 0 | **Access:** 🔒

**DOI:** [https://doi.org/10.1080/01496395.2025.2611021](https://doi.org/10.1080/01496395.2025.2611021)

**Topics:** Chemistry, Rare earth, Leaching (pedology), Solvent extraction, Extraction (chemistry)

---

### 5. Equilibrium and Mass Spectrometric Studies on the Rare-Earth Elements(III) Extraction with 4-Isopropyltropolone into Toluene

**Authors:** Michie EBISAWA, Akira Ohashi, Hisanori Imura, Kousaburo OHASHI

**Published:** 2025-12-29 | **Journal:** Solvent Extraction and Ion Exchange | **Citations:** 0 | **Access:** 🔒

**DOI:** [https://doi.org/10.1080/07366299.2025.2607534](https://doi.org/10.1080/07366299.2025.2607534)

**Topics:** Chemistry, Toluene, Extraction (chemistry), Chromatography, Mass spectrometry

---

## Extractants & Materials

### 1. Deep eutectic solvents as an emerging sustainable solvent for the separation and recovery of rare earth elements: current challenges and future prospectives

**Authors:** Huma Warsi Khan, B M Negash, Nur Insyriah Zulkifly, Mohd Dzul Hakim Wizral, Ainul Hakeem Abdul Jamil, et al.

**Published:** 2026-01-03 | **Journal:** Minerals Engineering | **Citations:** 0 | **Access:** 🔒

**DOI:** [https://doi.org/10.1016/j.mineng.2025.110051](https://doi.org/10.1016/j.mineng.2025.110051)

**Topics:** Rare earth, Eutectic system, Current (fluid), Materials science, Solvent

---

### 2. Hydrometallurgical recovery of heavy rare earth elements (HREE) from columbite leachate via aqueous complexation, solvent extraction and precipitation route

**Authors:** Bárbara da Rocha Pereira, Diego Teuber Gijon, Franco Garjulli, Denise Crocce Romano Espinosa, Jorge Alberto Soares Tenório

**Published:** 2025-12-31 | **Journal:** Minerals Engineering | **Citations:** 0 | **Access:** 🔒

**DOI:** [https://doi.org/10.1016/j.mineng.2025.110043](https://doi.org/10.1016/j.mineng.2025.110043)

**Topics:** Leachate, Rare earth, Precipitation, Aqueous solution, Chemistry

---

### 3. Augmenting Large Language Models for Automated Discovery of f-Element Extractants

**Authors:** B. Y. Zhang, Thomas J. Summers, Logan J. Augustine, Michael G. Taylor, Andreas Geist, et al.

**Published:** 2025-12-30 | **Journal:** Unknown Source | **Citations:** 0 | **Access:** 🔒

**DOI:** [https://doi.org/10.26434/chemrxiv-2025-b1m2q-v2](https://doi.org/10.26434/chemrxiv-2025-b1m2q-v2)

**Abstract:** Efficient separation of f-elements is a critical challenge for a wide range of emerging technologies. The chemical similarity among these elements makes the development of selective solvent extraction reagents both slow and difficult. Here, we present a quasi-autonomous, AI-enabled workflow for the design and computational screening of selective extractant ligands. Molecular design is guided by SAFE-MolGen, a large language model-based agentic system that leverages curated extraction data to pro...

**Topics:** Pipeline (software), Workflow, Computer science, Benchmark (surveying), Field (mathematics)
...
**Published:** 2026-01-02 | **Journal:** Molecules | **Citations:** 0 | **Access:** 🔓

**DOI:** [https://doi.org/10.3390/molecules31010176](https://doi.org/10.3390/molecules31010176)

**Abstract:** Dysprosium is one of the most critical elements for global economies due to its essential role in the green energy transition. Although it is added in small quantities as an alloying element, dysprosium plays a crucial role in NdFeB magnets used in wind turbines and industrial motors. On the other hand, the limited resources and production capacity of dysprosium contribute to supply shortages and raise concerns about its long-term availability. Therefore, there is a need for efficient techniques...

**Topics:** Dysprosium, Neodymium magnet, Economic shortage, Rare earth, Materials science

---

## Environmental & Sustainability

### 1. Exploring the Depths: The Effects of Deep-Sea Mining on Marine Diversity

**Authors:** Madhiha .

**Published:** 2026-01-02 | **Journal:** International Journal of Innovative Science and Research Technology (IJISRT) | **Citations:** 0 | **Access:** 🔓

**DOI:** [https://doi.org/10.38124/ijisrt/25dec1274](https://doi.org/10.38124/ijisrt/25dec1274)
...
### 1. The Reality and Challenges of Building a Global Rare Earth Supply Chain Beyond China

**Authors:** Younkyoo Kim, Sujin Kang

**Published:** 2025-12-30 | **Journal:** International Area Studies Review | **Citations:** 0 | **Access:** 🔒

**DOI:** [https://doi.org/10.21212/iasr.29.4.6](https://doi.org/10.21212/iasr.29.4.6)

**Topics:** Supply chain, China, Business, Rare earth, Chain (unit)

---

## Other

### 1. Inverse-Sandwich Rare Earth Metal Complexes Comprising a Planar Toluene Dianion

**Authors:** Elizabeth R. Pugliese, Saroshan Deshapriya, Mackenzie Meyer, Ernesto Castellanos, Selvan Demir

**Published:** 2026-01-03 | **Journal:** Inorganic Chemistry | **Citations:** 0 | **Access:** 🔓

**DOI:** [https://doi.org/10.1021/acs.inorgchem.5c04418](https://doi.org/10.1021/acs.inorgchem.5c04418)

**Abstract:** We report the first inverse-sandwich complexes containing rare earth (RE<sup>III</sup>) metal ions that captured a toluene dianion between them. Toluene-bridged complexes [{(Me<sub>3</sub>Si)<sub>2</sub>NC(N<sup>i</sup>Pr)<sub>2</sub>}<sub>2</sub>RE]<sub>2</sub>(μ-η<sup>6</sup>:η<sup>6</sup>-C<sub>6</sub>H<sub>5</sub>Me) (RE = Y (<b>1</b>), Dy (<b>2</b>), and Er (<b>3</b>)) were synthesized via chemical reductions of chloride-bridged RE complexes in which each tripositive metal is stabilized by ...
...
**Published:** 2026-01-01 | **Journal:** Macroeconomic Dynamics | **Citations:** 0 | **Access:** 🔒

**DOI:** [https://doi.org/10.1017/s136510052510076x](https://doi.org/10.1017/s136510052510076x)

**Abstract:** Abstract This study analyses the dynamics of the global rare earth element market, with a focus on China’s dominant role as the primary supplier, which is crucial for the energy transition and digitalization. Using a game-theoretic approach, the research examines a potential duopoly market structure that may emerge over time, as well as potential shifts in supply from China to other countries in this scenario. It considers China’s low marginal costs and factors such as resource extraction and di...

**Topics:** Duopoly, Economics, Futures studies, Microeconomics, Function (biology)
...
**Published:** 2025-12-29 | **Journal:** JOM | **Citations:** 0 | **Access:** 🔓

**DOI:** [https://doi.org/10.1007/s11837-025-08037-z](https://doi.org/10.1007/s11837-025-08037-z)
